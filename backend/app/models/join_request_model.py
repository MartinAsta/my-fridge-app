...
class JoinRequest(Base):
    ...
    __table_args__ = (
        UniqueConstraint("restaurant_id", "user_id", name="uq_join_request_restaurant_user"),
    )
    ...
    restaurant: Mapped["Restaurant"] = relationship("Restaurant", back_populates="join_requests")
